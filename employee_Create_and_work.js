...
// /* return employees with salary increase */

// function increaseSalary(employees, borderSalary, percent) {
//    return  employees.filter(empl => empl.salary < borderSalary).map(empl => {
//            const increase = empl.salary * percent / 100;
//             empl.salary += increase;
//          return empl;
//     })
// }
//
//  displayEmployees(increaseSalary(employees, borderSalary, percent););
